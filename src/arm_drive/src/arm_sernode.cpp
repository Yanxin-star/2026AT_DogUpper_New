...
ArmNode::ArmNode()
    ...
    arm_sub = this->create_subscription<robot_interfaces::msg::Arm>(
        "arm_target", 10, std::bind(&ArmNode::armSubscribCb, this, std::placeholders::_1));
...
void ArmNode::armSubscribCb(const robot_interfaces::msg::Arm& msg) {
    ...
    arm_target.servo1.low=msg.servo2.low;
    arm_target.servo1.up=msg.servo2.up;
    arm_target.rob01.except_pos=msg.rob01.rad;
    arm_target.rob01.except_omega=msg.rob01.omega;
    arm_target.rob01.except_torque=msg.rob01.torque;
    arm_target.rob02.target_pos=msg.rob02.rad;        

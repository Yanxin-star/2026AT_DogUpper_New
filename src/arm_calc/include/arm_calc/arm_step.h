...
public:
    ...
    typedef struct {
     ...
     typedef struct {
        ...
        StraightLineParam_t ly;
        StraightLineParam_t lz;
        StraightLineParam_t lw;
        double time;
    } Arm_trajectory; // 支撑相全程时间
    ...
    void update_arm_trajectory(const Vector4D& cur_pos, const Vector4D& final_pos,double time);
    void get_arm_pose(double t, Vector4D& pos);
